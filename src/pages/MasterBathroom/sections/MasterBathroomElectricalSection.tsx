...
// Define the complex shape of this section's data
...
export const MasterBathroomElectricalSection: React.FC<SectionProps> = ({
  initialData,
  onUpdate,
}) => {
